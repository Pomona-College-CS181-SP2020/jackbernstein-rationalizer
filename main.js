...
var $author$project$Main$numberPresentHelper = function (lst) {
	numberPresentHelper:
	while (true) {
		if (!lst.b) {
			return $elm$core$Maybe$Nothing;
			...
			var fst = lst.a;
			var rst = lst.b;
			var _v1 = A2($elm$parser$Parser$run, $elm$parser$Parser$float, fst);
			if (_v1.$ === 'Ok') {
				var x = _v1.a;
				...
				var $temp$lst = rst;
				lst = $temp$lst;
				continue numberPresentHelper;
			}
		}
	}
};
var $author$project$Main$removeNumber = function (lst) {
	if (!lst.b) {
		return _List_Nil;
	} else {
		var fst = lst.a;
		...
		if (_v1.$ === 'Ok') {
			...
			return A2(
				$elm$core$List$cons,
				fst,
				$author$project$Main$removeNumber(rst));
		}
	}
};
						...
						return _Utils_update(
							model,
							{
								changedNewIngs: _Utils_ap(
									...
									_List_fromArray(
										[
											{food: restOfString, quantity: x * model.sliderVal}
										])),
								listNewIngredients: _Utils_ap(
									model.listNewIngredients,
									_List_fromArray(
										[
											{food: restOfString, quantity: x}
										])),
								total: ''
							});
					} else {
